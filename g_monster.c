...
qboolean monster_start(edict_t* self)
{
	...
	//QW// if we are in a deathmatch and monster is a decoy, leave the  
	// skinnum alone, he's a clone of the player's skin
	if (deathmatch->value && strcmp(self->classname, "decoy") != 0) self->s.skinnum = 0;
