...
// portable case insensitive string compare functions
...
#define STAT_TEAM1_PIC			STAT_CTF_TEAM1_PIC
#define STAT_TEAM1_CAPS			STAT_CTF_TEAM1_CAPS
#define STAT_TEAM2_PIC			STAT_CTF_TEAM2_PIC
#define STAT_TEAM2_CAPS			STAT_CTF_TEAM2_CAPS

#define STAT_JOINED_TEAM1_PIC	STAT_CTF_JOINED_TEAM1_PIC
#define STAT_JOINED_TEAM2_PIC	STAT_CTF_JOINED_TEAM2_PIC
#define STAT_TEAM1_HEADER		STAT_CTF_TEAM1_HEADER
#define STAT_TEAM2_HEADER		STAT_CTF_TEAM2_HEADER
