...
void Cmd_LBind_f(edict_t *ent)
{
	...
	if (Q_strcasecmp(gi.argv(1),"ondeath") == 0) 
	{
		if (gi.argc() == 2) 
		{
	...
	if (Q_strcasecmp(gi.argv(1),"onrespawn") == 0) 
	{
		if (gi.argc() == 2) 
		{
	...
	if (Q_strcasecmp(gi.argv(1),"onenemydeath") == 0) 
	{
		if (gi.argc() == 2) 
		{
...
/*
if (Q_strcasecmp(gi.argv(1),"effects") == 0)
{
  ...
  ent->client->pers.effects = (int)atoi(gi.argv(2));
	...
	else if (Q_strcasecmp(gi.argv(1),"renderfx") == 0) 
	{
...
void Cmd_Help(edict_t *ent)
{
	...
	case 'a':
	case 'A':
		if (Q_strcasecmp (query, "airstrike") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Airstrike_Text);
		else if (Q_strcasecmp (query, "angel") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Angel_Text);			
		else if (Q_strcasecmp (query, "angels") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Angel_Text);	
		else if (Q_strcasecmp (query, "angelob") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOBlind_Text);
		else if (Q_strcasecmp (query, "angeloblind") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOBlind_Text);
		else if (Q_strcasecmp (query, "angelod") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOD_Text);
		else if (Q_strcasecmp (query, "angeloe") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOE_Text);
		else if (Q_strcasecmp (query, "angelof") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOF_Text);
		else if (Q_strcasecmp (query, "angeloflame") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOB_Text);
		else if (Q_strcasecmp (query, "angeloh") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOH_Text);
		else if (Q_strcasecmp (query, "angelohorror") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOH_Text);
		else if (Q_strcasecmp (query, "angelol") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOL_Text);
		else if (Q_strcasecmp (query, "angelom") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOM_Text);
		else if (Q_strcasecmp (query, "angelop") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOP_Text);
		else if (Q_strcasecmp (query, "angelor") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOR_Text);
		else if (Q_strcasecmp (query, "angelou") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AngelOU_Text);
		else if (Q_strcasecmp (query, "anticamper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AntiCamper_Text);
		else if (Q_strcasecmp (query, "anti-flaregun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_AntiFlareGun_Text);
		break;
		
	case 'b':
	case 'B':
		if (Q_strcasecmp (query, "banzai grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_BanzaiGrenade_Text);
		else if (Q_strcasecmp (query, "baton") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Baton_Text);
		else if (Q_strcasecmp (query, "bazooka sweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_BazookaSweeper_Text);
		else if (Q_strcasecmp (query, "blindness grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_BlindnessGrenade_Text);
		else if (Q_strcasecmp (query, "bazooka") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Bazooka_Text);
		else if (Q_strcasecmp (query, "buckyball") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_BuckyballLauncher_Text);
		else if (Q_strcasecmp (query, "buckyball launcher") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_BuckyballLauncher_Text);
		break;
		
	case 'c':
	case 'C':
		if (Q_strcasecmp (query, "cloak") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Cloak_Text);
		else if (Q_strcasecmp (query, "checkstats") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Checkstats_Text);
		else if (Q_strcasecmp (query, "chasecam") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Chasecam_Text);
		else if (Q_strcasecmp (query, "chunkgun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_ChunkGun_Text);
		else if (Q_strcasecmp (query, "cluster grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_ClusterGrenade_Text);
		else if (Q_strcasecmp (query, "cataclysm device") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_CataclysmDevice_Text);
		else if (Q_strcasecmp (query, "cat") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_CataclysmDevice_Text);
		break;
		
	case 'd':
	case 'D':
		if (Q_strcasecmp (query, "drop") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Drop_Text);
		else if (Q_strcasecmp (query, "decoy") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Decoy_Text); 
		else if (Q_strcasecmp (query, "detonate") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Detonate_Text);
		else if (Q_strcasecmp (query, "day") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_DayNight_Text);
		else if (Q_strcasecmp (query, "night") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_DayNight_Text);
		else if (Q_strcasecmp (query, "daynight") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_DayNight_Text);
		else if (Q_strcasecmp (query, "doubleimpact") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_DoubleImpact_Text);
		else if (Q_strcasecmp (query, "durggun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_DurgGun_Text);
		else if (Q_strcasecmp (query, "disruptor") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Disruptor_Text);
		break;
		
	case 'e':
	case 'E':
		if (Q_strcasecmp (query, "explosive") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Explosive_Text);
		else if (Q_strcasecmp (query, "energy vortex") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_EnergyVortex_Text);
		break;
		
	case 'f':
	case 'F':
		if (Q_strcasecmp (query, "flashlight") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Flashlight_Text);
		else if (Q_strcasecmp(query, "feign") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FeignDeath_Text);
		else if (Q_strcasecmp(query, "fph") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FPH_Text);
		else if (Q_strcasecmp (query, "firemode") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FireMode_Text);
		else if (Q_strcasecmp (query, "flamesweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FlameSweeper_Text);
		else if (Q_strcasecmp (query, "freezersweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FreezerSweeper_Text);
		else if (Q_strcasecmp (query, "freezer") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FreezeGun_Text);	
		else if (Q_strcasecmp (query, "freezegun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FreezeGun_Text);	
		else if (Q_strcasecmp (query, "flaregun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FlareGun_Text);
		else if (Q_strcasecmp (query, "freezegrenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FreezeGrenade_Text);	
		else if (Q_strcasecmp (query, "flamethrower") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FlameThrower_Text);
		else if (Q_strcasecmp (query, "fbfg") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FBFG_Text);			
		else if (Q_strcasecmp (query, "freezatron") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Freezatron_Text);		
		else if (Q_strcasecmp (query, "freezatron grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_FreezatronGrenade_Text);	
		break;
		
	case 'g':
	case 'G':
		if (Q_strcasecmp (query, "grenadesweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_GrenadeSweeper_Text);
		else if (Q_strcasecmp (query, "grapple") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Hook_f_Text);
		else if (Q_strcasecmp (query, "grenades") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Grenades_Text);	
		else if (Q_strcasecmp (query, "grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Grenades_Text);	
		else if (Q_strcasecmp (query, "darkmajickgrenades") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Grenades_Text);	
		else if (Q_strcasecmp (query, "guided missile") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_GuidedMissile_Text);	
		break;
		
	case 'h':
	case 'H':
		if (Q_strcasecmp (query, "help") == 0) 
		{
		...
		else if (Q_strcasecmp (query, "height") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Height_Text);
		else if (Q_strcasecmp (query, "hook") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Hook_f_Text);
		else if (Q_strcasecmp (query, "homer grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_HomerGrenade_Text);
		else if (Q_strcasecmp (query, "homing rocket launcher") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_HomingRocketLauncher_Text);	
		else if (Q_strcasecmp (query, "holoquad") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Holoquad_Text);
		else if (Q_strcasecmp (query, "holoinvul") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Holoinvul_Text);
		else if (Q_strcasecmp (query, "holobfg") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Holobfg_Text);
		else if (Q_strcasecmp (query, "holoweapon") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Holoweapon_Text);
		break;
		
	case 'i':
	case 'I':
		if (Q_strcasecmp(query, "id") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlayerID_Text);
		else if (Q_strcasecmp(query,"invis") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_NewCloak_Text);
		else if (Q_strcasecmp (query, "icecube gun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_IcecubeGun_Text);	
		break;
		
	case 'k':
	case 'K':
		if (Q_strcasecmp (query, "kamikaze") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Kamikaze_Text);
		break;
		
	case 'l':
	case 'L':
		if (Q_strcasecmp (query, "lbind") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_LBind_Text);
		else if (Q_strcasecmp (query, "lox") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_LOX_Text);
		else if (Q_strcasecmp (query, "lsight") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_LaserSight_Text);
		else if (Q_strcasecmp (query, "laser") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlaceLaserTripwire_Text);
		else if (Q_strcasecmp (query, "logplayers") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_LogPlayers_Text);
		else if (Q_strcasecmp (query, "lightning gun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_LightningGun_Text);
		break;
		
	case 'm':
	case 'M':
		if (Q_strcasecmp (query, "mace") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Mace_Text);
		else if (Q_strcasecmp (query, "machine rocket gun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_MachineRocketGun_Text);
		else if (Q_strcasecmp (query, "machinegun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_MachineGun_Text);
		else if (Q_strcasecmp (query, "midnight grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_MidnightGrenade_Text);
		break;
		
	case 'n':
	case 'N':
		if (Q_strcasecmp (query, "nightvision") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Lowlight_Text);
		else if (Q_strcasecmp (query, "nailgun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Nailgun_Text);
		else if (Q_strcasecmp (query, "napalm grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_NapalmGrenade_Text);
		break;
		
	case 'o':
	case 'O':
		if (Q_strcasecmp(query, "organic") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_OrganicArmor_Text);
		else if (Q_strcasecmp(query, "organic armor") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_OrganicArmor_Text);
		break;			
		
	case 'p':
	case 'P':
		if (Q_strcasecmp (query, "push") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Tractor_Text);
		else if (Q_strcasecmp (query, "pull") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Tractor_Text);
		else if (Q_strcasecmp(query, "playerid") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlayerID_Text);
		else if (Q_strcasecmp(query, "plasma grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlasmaGrenade_Text);
		else if (Q_strcasecmp(query, "plasma cluster grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlasmaClusterGrenade_Text);
		else if (Q_strcasecmp(query, "plasma rifle") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PlasmaRifle_Text);
		else if (Q_strcasecmp(query, "positron") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Positron_Text);
		else if (Q_strcasecmp(query, "positron grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_PositronGrenade_Text);
		break;
		
	case 'r':
	case 'R':
		if (Q_strcasecmp (query, "range") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Rangefinder_Text);
		else if (Q_strcasecmp(query, "revenge") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Revenge_Text);
		else if (Q_strcasecmp (query, "railgun sweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_RailgunSweeper_Text);
		else if (Q_strcasecmp(query, "rocket grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_RocketGrenade_Text);
		else if (Q_strcasecmp(query, "railbomb") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_RailBomb_Text);
		break;
		
	case 's':
	case 'S':
		if (Q_strcasecmp (query, "scanner") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Scanner_Text);
		else if (Q_strcasecmp (query, "score") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Score_Text);
		else if (Q_strcasecmp (query, "shrapnel grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_ShrapnelGrenade_Text);
		else if (Q_strcasecmp (query, "skinlist") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Skinlist_Text);
		else if (Q_strcasecmp (query, "skipper homing rocket") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SkipperHomingRocket_Text);
		else if (Q_strcasecmp (query, "slugarmor") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SlugArmor_Text);
		else if (Q_strcasecmp (query, "snipergun") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SniperGun_Text);
		else if (Q_strcasecmp (query, "streetsweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_StreetSweeper_Text);
		else if (Q_strcasecmp (query, "spinning rail grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SpinningRailGrenade_Text);
		else if (Q_strcasecmp (query, "sticking grenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_StickingGrenade_Text);
		else if (Q_strcasecmp (query, "superblaster") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Superblaster_Text);
		else if (Q_strcasecmp (query, "superblastersweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SuperblasterSweeper_Text);
		else if (Q_strcasecmp (query, "sweeper") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Sweepers_Text);
		else if (Q_strcasecmp (query, "sweeperfiremode") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_SweeperFireMode_Text);
		break;
		
	case 't':
	case 'T':
		if (Q_strcasecmp (query, "tracker") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Tracker_Text);
		else if (Q_strcasecmp (query, "teleportgrenade") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_TeleportGrenade_Text);
		else if (Q_strcasecmp (query, "time") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Time_Text);
		else if (Q_strcasecmp (query, "timeleft") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Timeleft_Text);
		else if (Q_strcasecmp (query, "timeremaining") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Timeleft_Text);
		else if (Q_strcasecmp (query, "timeall") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Timeall_Text);
		else if (Q_strcasecmp (query, "turret") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Turret_Text);
		else if (Q_strcasecmp (query, "trackercount") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_TrackerCount_Text);
		else if (Q_strcasecmp (query, "turretcount") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_TurretCount_Text);
		break;
		
	case 'v':
	case 'V':
		if (Q_strcasecmp (query, "ver") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Ver_Text);
		else if (Q_strcasecmp (query, "vacuummaker") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_VacuumMaker_Text);
		else if (Q_strcasecmp (query, "vote") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Voting_Text);
		else if (Q_strcasecmp (query, "voting") == 0) gi.cprintf(ent, PRINT_MEDIUM, Info_Voting_Text);
		break;
...
void ClientCommand (edict_t *ent)
{
	...
	if (level.intermissiontime)
	{
		if (Q_strcasecmp (cmd, "players") == 0)
			...
			|| Q_strcasecmp (cmd, "steam") == 0)
		{
			Cmd_Say_f (ent, QTRUE, QFALSE);
		}
		else if (Q_strcasecmp (cmd, "score") == 0)
			Cmd_Score_f (ent);
		else if (Q_strcasecmp (cmd, "help") == 0)
			Cmd_Help_f (ent);
		else if (Q_strcasecmp (cmd, "checkstats") == 0)
	...
	case 'a':
		...
		if ( Q_strcasecmp (cmd, "angelod") == 0) Cmd_AngelOD(ent);		//death
		else if ( Q_strcasecmp (cmd, "angelol") == 0) Cmd_AngelOL(ent);	//life
		else if ( Q_strcasecmp (cmd, "angelom") == 0) Cmd_AngelOM(ent);	//mercy
		else if ( Q_strcasecmp (cmd, "angeloe") == 0) Cmd_AngelOE(ent);	//energy
		else if ( Q_strcasecmp (cmd, "angelof") == 0) Cmd_AngelOF(ent);	//frost
		else if ( Q_strcasecmp (cmd, "angelop") == 0) Cmd_AngelOP(ent);	//plague
		else if ( Q_strcasecmp (cmd, "angeloflame") == 0) Cmd_AngelOB(ent);	//flame
		else if ( Q_strcasecmp (cmd, "angeloh") == 0) Cmd_AngelOH(ent);	//horror
		else if ( Q_strcasecmp (cmd, "angelohorror") == 0) Cmd_AngelOH(ent);	//horror
		else if ( Q_strcasecmp (cmd, "angelob") == 0) Cmd_AngelOBlind(ent);	//blindness
		else if ( Q_strcasecmp (cmd, "angeloblind") == 0) Cmd_AngelOBlind(ent);	//blindness
		else if ( Q_strcasecmp (cmd, "angelor") == 0) Cmd_AngelOR(ent);		//revenge
		else if ( Q_strcasecmp (cmd, "angelou") == 0) Cmd_AngelOU(ent);	//unfreeze
		
		// CCH: new command for calling airstrikes
		else if (Q_strcasecmp (cmd, "airstrike") == 0)
			Cmd_Airstrike_f (ent);
		else
	...
	case 'd':
		if (Q_strcasecmp (cmd, "drop") == 0)
			Cmd_Drop_f (ent);
		else if (Q_strcasecmp (cmd, "droparmor") == 0)
			Cmd_DropArmor_f(ent);
		else if (Q_strcasecmp (cmd, "decoy") == 0)
			Toggle_Decoy_f (ent); 
		else if (Q_strcasecmp (cmd, "detonate") == 0)
			Cmd_Detonate_f(ent);
		else if (Q_strcasecmp (cmd, "devmenu") == 0)
	...
	case 'e':
		if (Q_strcasecmp (cmd, "explosive") == 0)
			Cmd_Explosive (ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 'f':
		if (Q_strcasecmp (cmd, "flashlight") == 0)
			Cmd_Flashlight (ent);
		else if (Q_strcasecmp(cmd, "feign") == 0)
			Cmd_FeignDeath (ent);
		else if (Q_strcasecmp(cmd, "fph") == 0)
			Cmd_FPH(ent);
		else if (Q_strcasecmp (cmd, "firemode") == 0)
			Cmd_FireMode_f (ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 'h':
		if (Q_strcasecmp (cmd, "help") == 0)
			Cmd_Help_f (ent);
		else if (Q_strcasecmp (cmd, "height") == 0)
			Cmd_Height(ent);
		else if (Q_strcasecmp (cmd, "hook") == 0)
			Cmd_Hook_f (ent);
		else if (Q_strcasecmp (cmd, "holoquad") == 0)
			Cmd_Holoquad_f (ent);
		else if (Q_strcasecmp (cmd, "holoinvul") == 0)
			Cmd_Holoinvul_f(ent);
		else if (Q_strcasecmp (cmd, "holobfg") == 0)
			Cmd_Holobfg_f(ent);
		else if (Q_strcasecmp (cmd, "holoweapon") == 0)
	...
	case 'i':
		if (Q_strcasecmp (cmd, "id") == 0)
			Cmd_PlayerID(ent);
		else if (Q_strcasecmp(cmd,"invis") == 0)
			Cmd_Invisible(ent);
	...
	case 'l':
		if (Q_strcasecmp (cmd, "lsight") == 0) 
			SP_LaserSight (ent);
		else if (Q_strcasecmp (cmd, "laser") == 0) 
			PlaceLaserTripwire (ent);
		else if (Q_strcasecmp (cmd, "logplayers") == 0)
			Cmd_LogPlayers_f(ent);
		else if (Q_strcasecmp (cmd,"lbind") == 0)
			Cmd_LBind_f(ent);
		else if (Q_strcasecmp (cmd,"location") == 0)
			Cmd_Location_f(ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 'n':
		if (Q_strcasecmp (cmd, "notarget") == 0)
			Cmd_Notarget_f (ent);
		else if (Q_strcasecmp (cmd, "noclip") == 0)
			Cmd_Noclip_f (ent);
		else if (Q_strcasecmp (cmd, "nightvision") == 0)
			Cmd_Lowlight_f (ent);
...
// For oakbot, bot code not debugged.
	case 'o':
		if (Q_strcasecmp (cmd, "oak") == 0) //spawn oak bot
			SP_Oak_f(ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 'p':
		if (Q_strcasecmp (cmd, "push") == 0)
			Cmd_Push_f (ent);
		else if (Q_strcasecmp (cmd, "pull") == 0)
			Cmd_Pull_f (ent);
		...
		else if (Q_strcasecmp(cmd, "playerid") == 0)
			Cmd_PlayerID(ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 's':
		...
		else if (Q_strcasecmp (cmd, "sweeperfiremode") == 0)
	...
	case 't':
		if (Q_strcasecmp (cmd, "thirdx") == 0)
			Cmd_ThirdX_f (ent);
		else if (Q_strcasecmp (cmd, "thirdz") == 0)
			Cmd_ThirdZ_f (ent);
		else if (Q_strcasecmp (cmd, "team") == 0)
			CTFTeam_f (ent);
		else if (Q_strcasecmp (cmd, "tracker") == 0)
			Cmd_Tracker_f (ent);
		else if (Q_strcasecmp (cmd, "trackercount") == 0)
			Cmd_TrackerCounter (ent);
		else if (Q_strcasecmp (cmd, "turretcount") == 0)
		...
		else if ((Q_strcasecmp (cmd,"timeremaining") == 0) || (Q_strcasecmp (cmd,"timeleft") == 0))
		{
			Cmd_TimeRemaining_f(ent);
			ent->spamtimer = level.time + 6.0f;	// anti spammage
		}
		else if (Q_strcasecmp (cmd,"timeall") == 0)
		{
			Cmd_TimeAll_f(ent);
			ent->spamtimer = level.time + 6.0f;	// anti spammage
		}
		else if (Q_strcasecmp (cmd, "turret") == 0)
			Cmd_Turret_f (ent);
		else
			Cmd_NotRecognized(ent);
		break;
	...
	case 'w':
		if (Q_strcasecmp (cmd, "weapprev") == 0)
			Cmd_WeapPrev_f (ent);
			...
			Cmd_Wave_f (ent);
		else if (Q_strcasecmp (cmd, "weallknow") == 0)
			Cmd_WWW_f ();
		else
			Cmd_NotRecognized(ent);
		break;
