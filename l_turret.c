...
{
	vec3_t targetdir = { 0 };
	vec3_t forward = { 0 }, blipdir = { 0 }, v = { 0 };
	edict_t* blip = NULL;
	...
	if (ent->enemy != NULL)
	{
		...
		if (strcmp(ent->turretammotype, "Blaster") == 0)
			...
			fire_grenade_dM(ent->owner,
				...
				false, // held
				false); // bazookad		
		else if (strcmp(ent->turretammotype, "Sticking Grenades") == 0)
			fire_stickinggrenade(ent->owner, ent->s.origin, ent->movedir, 120, 600, 2.5, 40);
		else if (strcmp(ent->turretammotype, "Buckyball Launcher") == 0)
			fire_buckyball(ent->owner, ent->s.origin, ent->movedir, BUCKY_DAMAGE, BUCKY_SPEED, 90);
		else if (strcmp(ent->turretammotype, "Bazooka") == 0)
			fire_grenade_dM(ent->owner,
				ent->s.origin,
				ent->movedir,
				120, //damage
				...
				false, // held
				true); // bazookad
		else if (strcmp(ent->turretammotype, "Double Impact") == 0)
		{
		...
		else if (strcmp(ent->turretammotype, "Rocket Launcher") == 0)
			fire_flamerocket(ent->owner, ent->s.origin, ent->movedir, (100 + (int)(random() * 20.0)), 650, 120, 120);
		else if (strcmp(ent->turretammotype, "Lightning Gun") == 0)
			fire_lightning(ent->owner, ent->s.origin, ent->movedir, 30);
		else if (strcmp(ent->turretammotype, "Positron") == 0)
		{
			PositronBeamFire(ent->owner, ent->s.origin, ent->movedir);
			ent->nextthink = level.time + 1.0f;
		}
		else if (strcmp(ent->turretammotype, "Freezatron") == 0)
		{
			FreezatronBeamFire(ent->owner, ent->s.origin, ent->movedir);
			ent->nextthink = level.time + 1.0f;
		}
		else if (strcmp(ent->turretammotype, "HyperBlaster") == 0)
			fire_blaster(ent->owner, ent->s.origin, ent->movedir, 15, 1000, EF_HYPERBLASTER /* , hyper */);
		else if (strcmp(ent->turretammotype, "Icecube Gun") == 0)
			fire_freezer(ent->owner, ent->s.origin, ent->movedir, FREEZER_DAMAGE, FREEZER_SPEED, EF_BLASTER);
		else if (strcmp(ent->turretammotype, "Super Blaster") == 0)
			fire_super(ent->owner, ent->s.origin, ent->movedir, 50, 1000, EF_BLASTER /* , hyper */);
		else if (strcmp(ent->turretammotype, "Railgun2") == 0)
			fire_rail(ent->owner, ent->s.origin, ent->movedir, 150, 8);
		else if (strcmp(ent->turretammotype, "Wall Piercing Railgun") == 0)
			fire_rail(ent->owner, ent->s.origin, ent->movedir, 150, 8);
		else if (strcmp(ent->turretammotype, "Railgun") == 0)
		{
			vec3_t temp = { 6, 9, 25 };
			vec3_t temp2 = { 6, 4, 25 };
			PBM_FireFlamer(ent->owner, ent->s.origin, ent->movedir, 1200, 70, temp, temp2, 100, 50);
		}
		else if (strcmp(ent->turretammotype, "Durg") == 0)
			fire_durg(ent->owner, ent->s.origin, ent->movedir, 0, 2);
		else if (strcmp(ent->turretammotype, "Energy Vortex") == 0)
			fire_energyvortex(ent->owner, ent->s.origin, ent->movedir, 200, 500, 1000);
		else if (strcmp(ent->turretammotype, "BFG10K") == 0)
			fire_bfg(ent->owner, ent->s.origin, ent->movedir, 200, 400, 1000);
		else if (strcmp(ent->turretammotype, "FBFG") == 0)
			fire_fbfg(ent->owner, ent->s.origin, ent->movedir, 200, 400, 1000);
		else if (strcmp(ent->turretammotype, "Sniper Gun") == 0)
			fire_sniper(ent->owner, ent->s.origin, ent->movedir, 300, 2500, EF_BLASTER);
		else if (strcmp(ent->turretammotype, "Snipersweeper") == 0)
			fire_sniper(ent->owner, ent->s.origin, ent->movedir, 300, 2500, EF_BLASTER);
		else if (strcmp(ent->turretammotype, "Plasma Rifle") == 0)
			fire_plasma(ent->owner, ent->s.origin, ent->movedir, 15, 1200, EF_BFG);

		else if (strcmp(ent->turretammotype, "Explosive Chaingun") == 0)
			fire_explosive_bullet(ent->owner, ent->s.origin, ent->movedir, 6, 7, 300, 500, MOD_EXPLOSIVECHAINGUN);
		else if (strcmp(ent->turretammotype, "Explosive Super Shotgun") == 0)
		{
		...
		else if (strcmp(ent->turretammotype, "Explosive Shotgun") == 0)
		...
		else if (strcmp(ent->turretammotype, "Explosive Streetsweeper") == 0)
...
void Turret_Weapon_Fire(edict_t* ent)
{
	...
	if (strcmp(ent->client->pers.weapon->pickup_name, "Guided Missile") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Sword") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Flaregun") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Anti-Flaregun") == 0) return;
	else if (strcmp(ent->client->pers.weapon->icon, "a_grenades") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Vacuum Maker") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Spiral Rocket Launcher") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Homing Rocket Launcher") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Skipper Homing Rocket") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Teleport Grenade") == 0) return;
	else if (strcmp(ent->client->pers.weapon->pickup_name, "Floating Mine Launcher") == 0) return;
	...
	if ((strcmp(ent->client->pers.weapon->pickup_name, "BFG10K") == 0) &&
		((i_loxturretban & LTB_BFG10K))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Buckyball Launcher") == 0) &&
		((i_loxturretban & LTB_BUCKY))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Disruptor") == 0) &&
		((i_loxturretban & LTB_DISINTEGRATOR))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Double Impact") == 0) &&
		((i_loxturretban & LTB_DOUBLEIMPACT))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Durg") == 0) &&
		((i_loxturretban & LTB_DURG))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Energy Vortex") == 0) &&
		((i_loxturretban & LTB_ENERGYVORTEX))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Explosive Shotgun") == 0) &&
		((i_loxturretban & LTB_EXPLOSIVESHOTGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Explosive Super Shotgun") == 0) &&
		((i_loxturretban & LTB_EXPLOSIVESUPERSHOTGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Explosive Machinegun") == 0) &&
		((i_loxturretban & LTB_EXPLOSIVEMACHINEGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "FBFG") == 0) &&
		((i_loxturretban & LTB_FBFG))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Freezer") == 0) &&
		((i_loxturretban & LTB_FREEZEGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Icecube Gun") == 0) &&
		((i_loxturretban & LTB_ICECUBEGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Kaminit") == 0) &&
		((i_loxturretban & LTB_KAMINIT))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Lightning Gun") == 0) &&
		((i_loxturretban & LTB_LIGHTNINGGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Nailgun") == 0) &&
		((i_loxturretban & LTB_NAILGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Positron") == 0) &&
		((i_loxturretban & LTB_POSITRON))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Freezatron") == 0) &&
		((i_loxturretban & LTB_FREEZATRON))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Pulserifle") == 0) &&
		((i_loxturretban & LTB_PULSERIFLE))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Railgun") == 0) &&
		((i_loxturretban & LTB_RAILGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Sticking Grenades") == 0) &&
		((i_loxturretban & LTB_STICKGRENADELAUNCHER))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Sniper Gun") == 0) &&
		((i_loxturretban & LTB_SNIPERGUN))) return;
	if ((strcmp(ent->client->pers.weapon->pickup_name, "Snipersweeper") == 0) &&
		((i_loxturretban & LTB_SNIPERGUN))) return;
