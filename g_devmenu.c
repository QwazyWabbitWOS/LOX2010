...
void Cmd_DevMenu_f(char *scmd, edict_t *ent)
{
	...
	else if (Q_strcasecmp (scmd, "close") == 0)
	{
		PMenu_Close(ent);
	}
	
	else if (Q_strcasecmp (scmd, "text") == 0)
	{
	...
	else if (Q_strcasecmp (scmd, "reset") == 0)
	{
